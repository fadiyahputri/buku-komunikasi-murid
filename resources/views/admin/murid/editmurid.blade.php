            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <h4 class="card-title mb-3">Edit Murid</h4>
                  <form action="{{ url('/murid/update/', $m->id) }}" method="post" class="form-group">
                    {{ csrf_field() }}
                    <label for="exampleInputUsername1">Nama Murid</label>
                    <input type="text" class="form-control" id="nama_murid" name="nama_murid" placeholder="nama" value="{{ $m -> nama_murid }}"/>
                    </div>
                    <div class="form-pleInputEmail1">Jurusan</label>
                      <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="pilih jurusan" value="{{ $m -> jurusan }}"/>
                    </div>group">
                      <label for="exampleInputEmail1">Kelas</label>
                      <input type="text" class="form-control" id="kelas" name="kelas" placeholder="pilih kelas" value="{{ $m -> kelas }}"/>
                    </div>
                    <div class="form-group">
                      <label for="exam
                    <div class="form-group">
                      <label for="exampleInputPassword1">NISN</label>
                      <input type="number" class="form-control" id="nisn" name="nisn" placeholder="nisn" value="{{ $m -> nisn }}"/>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Jenis Kelamin</label>
                      <input type="text" class="form-control" id="jenis_kelamin" name="jenis_kelamin" placeholder="" value="{{ $m -> jenis_kelamin }}"/>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Alamat</label>
                      <input type="text" class="form-control" id="alamat" name="alamat" placeholder="tuliskan alamatmu" value="{{ $m -> alamat }}"/>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">No.Telp</label>
                      <input type="number" class="form-control" id="no_telp" name="no_telp" placeholder="+62" value="{{ $m -> no_telepon }}"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="password" name="password" placeholder="password" value="{{ $m -> password }}"/>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Wali Kelas</label>
                      <input type="text" class="form-control" id="wali_kelas" name="wali_kelas" placeholder="mata pelajaran" value="{{ $m -> wali_kelas }}"/>
                    </div>
                    <div class="mb-0 d-flex align-center">
                      <button class="btn btn-light">Cancel</button>
                      <a href="{{ url('/murid/update/, {id}') }}">
