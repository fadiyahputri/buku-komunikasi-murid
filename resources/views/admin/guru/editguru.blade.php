  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="{{ url('/guru/update', $g->id) }}" method="POST" class="form-sample">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama_guru" name="nama_guru" placeholder="nama" value="{{ $g -> nama_guru }}" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="password" name="password" placeholder="password"  value="{{ $g -> password }}"/>
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <select class="form-control" id="mata_pelajaran" name="mata_pelajaran" placeholder="pilih matpel" value="{{ $g -> mata_pelajaran }}">
                      <option>PAI</option>
                      <option>PPKN</option>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="number" class="form-control" id="nip" name="nip" placeholder="nip" value="{{ $g -> nip }}"/>
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="wali_kelas" name="wali_kelas" placeholder="example : X PPLG 1" value="{{ $g -> wali_kelas }}"/>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="email" class="form-control" id="email" name="email" placeholder="example@gmail.com" value="{{ $g -> email }}"/>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <h4 class="card-title mb-3">Edit Murid</h4>
                          <form action="{{ url('/murid/update/, {id}', $g->id) }}" method="post" class="form-group">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="mata_pelajaran" name="mata_pelajaran" placeholder="pilih matpel" value="{{ $g -> mata_pelajaran }}"/>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputEmail1">Wali Kelas</label>
                              <input type="text" class="form-control" id="wali_kelas" name="wali_kelas" placeholder="pilih walas" value="{{ $g -> wali_kelas }}"/>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Email</label>
                              <input type="number" class="form-control" id="email" name="email" placeholder="email" value="{{ $g -> email }}"/>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Password</label>
                              <input type="text" class="form-control" id="password" name="password" placeholder="" value="{{ $g -> password }}"/>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">NIP</label>
                              <input type="text" class="form-control" id="nip" name="nip" placeholder="" value="{{ $g -> nip }}"/>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Alamat</label>
                              <input type="text" class="form-control" id="alamat" name="alamat" placeholder="tuliskan alamatmu" value="{{ $g -> alamat }}"/>
                            </div>
                            <div class="mb-0 d-flex align-center">
                              <button class="btn btn-light">Cancel</button>
                              <a href="{{ url('/guru/update/, {id}') }}">
